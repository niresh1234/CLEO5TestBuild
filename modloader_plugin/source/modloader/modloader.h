...
/* Forwarding */
struct modloader_t;
struct CLEO_ModLoader_Plugin_t;
...
*/
typedef void (*modloader_fGetPluginData)(CLEO_ModLoader_Plugin_t* data);
 ...
 */
typedef const char* (*modloader_fGetVersion)(CLEO_ModLoader_Plugin_t* data);
 ...
 *      @data: The plugin data 
 */
typedef const char* (*modloader_fGetAuthor)(CLEO_ModLoader_Plugin_t* data);
 ...
 */
typedef int (*modloader_fOnStartup)(CLEO_ModLoader_Plugin_t* data);
 ...
 *      @return 0 on success and 1 on failure;
 */
typedef int (*modloader_fOnShutdown)(CLEO_ModLoader_Plugin_t* data);
 ...
 * 
 */
typedef int (*modloader_fGetBehaviour)(CLEO_ModLoader_Plugin_t* data, modloader_file_t* file);
 ...
 *      @return 0 on success and 1 on failure;
 */
typedef int (*modloader_fInstallFile)(CLEO_ModLoader_Plugin_t* data, const modloader_file_t* file);
 ...
 *      @return 0 on success and 1 on failure;
 */
typedef int (*modloader_fReinstallFile)(CLEO_ModLoader_Plugin_t* data, const modloader_file_t* file);
 ...
 *      @return 0 on success and 1 on failure;
 */
typedef int (*modloader_fUninstallFile)(CLEO_ModLoader_Plugin_t* data, const modloader_file_t* file);
 ...
 *      @data: The plugin data
 */
typedef void (*modloader_fUpdate)(CLEO_ModLoader_Plugin_t* data);




/* ---- Interface ---- Should be compatible with all versions of modloader.asi */
typedef struct CLEO_ModLoader_Plugin_t
{
